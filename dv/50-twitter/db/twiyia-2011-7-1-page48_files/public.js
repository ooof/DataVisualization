...
function onReplie($this){
	var replie_id = getScreenName($this.parent().parent().find(".status_word").find(".user_name").text());
	$("#textbox").focus();
...
function onRT($this){
	var replie_name = $this.parent().parent().find(".status_word").find(".user_name").text();
	var replie_id = getScreenName(replie_name);
	$("#textbox").val("RT @" + replie_id + ":" + $this.parent().parent().find(".status_word").text().replace(replie_name, ""));
	$("#textbox").focus();
	leaveWord();
}
